    ...
    <form id="form1" action="<?php echo site_url('temporary_user/TemporaryUser/create') ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input id="admission_date" name="admission_date" placeholder="" type="date" class="form-control" value="<?php echo set_value('admission_date', date($this->customlib->getSchoolDateFormat())); ?>" />
        ...
        <div class="row bg-light rounded-bottom shadow p-3 mb-4">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo "Total Mark" ?></label><small class="text-danger"> *</small>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input type="text" id="chem_markob" class="form-control" name="chem_markob" value="<?php echo set_value('chem_markob'); ?>" />
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input type="text" id="chem_maxmark" class="form-control" name="chem_maxmark" value="<?php echo set_value('chem_maxmark'); ?>" />
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input type="text" id="chem_per" class="form-control chem-percentage" name="chem_per" value="<?php echo set_value('chem_per'); ?>" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input type="text" id="phy_markob" class="form-control" name="phy_markob" value="<?php echo set_value('phy_markob'); ?>" />
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input type="text" id="phy_maxmark" class="form-control" name="phy_maxmark" value="<?php echo set_value('phy_maxmark'); ?>" />
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input type="text" id="phy_per" class="form-control" name="phy_per" value="<?php echo set_value('phy_per'); ?>" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input type="text" id="bio_markob" class="form-control" name="bio_markob" value="<?php echo set_value('bio_markob'); ?>" />
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input type="text" id="bio_maxmark" class="form-control" name="bio_maxmark" value="<?php echo set_value('bio_maxmark'); ?>" />
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input type="text" id="bio_per" class="form-control" name="bio_per" value="<?php echo set_value('bio_per'); ?>" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input type="text" id="tot1" class="form-control" name="tot1" value="<?php echo set_value('tot1'); ?>" readonly />
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input type="text" id="tot2" class="form-control" name="tot2" value="<?php echo set_value('tot2'); ?>" readonly />
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input type="text" id="tot3" class="form-control" name="tot3" value="<?php echo set_value('tot3'); ?>" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input type="text" id="eng_markob" class="form-control" name="eng_markob" value="<?php echo set_value('eng_markob'); ?>" />
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input type="text" id="eng_maxmark" class="form-control" name="eng_maxmark" value="<?php echo set_value('eng_maxmark'); ?>" />
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input type="text" id="eng_per" class="form-control eng-percentage" name="eng_per" value="<?php echo set_value('eng_per'); ?>" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input type="text" id="total_markobtained" class="form-control" name="total_mark" value="<?php echo set_value('total_mark'); ?>" readonly />
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input type="text" id="total_maxmark" class="form-control" name="total_maxmark" value="<?php echo set_value('total_maxmark'); ?>" readonly />
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        <input type="text" id="total_per" class="form-control" name="total_per" value="<?php echo set_value('total_per'); ?>" />
                    </div>
                </td>
            </tr>
        </tbody>
